...
public class StringLongPair implements WritableComparable<StringLongPair> {
   ...
   */
  public StringLongPair(String left, long right) {
    set(left, right);
  }
  ...
  public boolean equals(Object obj) {
    StringLongPair pair = (StringLongPair) obj;
   ...
   *         <code>obj</code>.
   */
  public int compareTo(StringLongPair pair) {
   ...
   */
  public StringLongPair clone() {
    return new StringLongPair(this.leftElement, this.rightElement);
  }
  ...
  static { // register this comparator
    WritableComparator.define(StringLongPair.class, new Comparator());
  }
